...
class regressor():
    ...
    def __init__(self, input_shape, gpu, write_result_out_dir, pre_model=None, noise=None):
        self.model = self.build_model(input_shape, gpu, write_result_out_dir, pre_model=pre_model, noise=noise)
        self.hist = None

    def build_model(self, input_shape: tuple, gpu, write_result_out_dir, pre_model=None, noise=None, verbose=True):
        if gpu:
